...
namespace IntelligentScissors
{
    class Priorty_Queue
    {
        ...
        {
            //OutPut File
            string fileName = @"C:\Users\JoOo\Desktop\final\[TEMPLATE] IntelligentScissors\Testcases\Sample\Case1\OutShort.txt";
            StreamWriter fs;
           ...
           // key-> child value->parent
            ...
            while (!(priority_queue.Count == 0))
            {
                ...
                {
                    fs.WriteLine( " Node: " + d.Value+ " at position X = " + parent[d.Key] % width + ", and  position Y= " + parent[d.Key] / width);
